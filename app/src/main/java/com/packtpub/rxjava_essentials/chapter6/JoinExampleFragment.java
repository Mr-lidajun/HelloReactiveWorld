 ...
 * @date 2017/4/7 12:53.
 * @desc: JoinExampleFragment
 */

public class JoinExampleFragment extends Fragment {
    private static final String TAG = JoinExampleFragment.class.getSimpleName();
    ...
    private void loadList(List<AppInfo> apps) {
        ...
        appsSequence
                .join(tictoc, appInfo -> Observable.timer(2, TimeUnit.SECONDS),
