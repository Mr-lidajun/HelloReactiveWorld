...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        final TypedArray a = context.obtainStyledAttributes(attrs,
                com.packtpub.rxjava_essentials.R.styleable.ScrimInsetsView, defStyle, 0);
        if (a == null) {
            return;
        }
        mInsetForeground = a.getDrawable(com.packtpub.rxjava_essentials.R.styleable.ScrimInsetsView_insetForeground);
        a.recycle();
