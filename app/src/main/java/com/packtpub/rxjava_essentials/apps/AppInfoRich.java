...
public class AppInfoRich implements Comparable<Object> {
    ...
    public Drawable getIcon() {
        if (icon == null) {
            ...
            /*
             * Drawable dr =
             * getResolveInfo().loadIcon(mContext.getPackageManager()); Bitmap
             * bitmap = ((BitmapDrawable) dr).getBitmap(); icon = new
             * BitmapDrawable(mContext.getResources(),
             * AppHelper.getResizedBitmap(bitmap, 144, 144));
             */
        }
        return icon;
    }
